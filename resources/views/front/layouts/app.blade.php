        ...
        <div class="container">
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-3 col-12 logo">
                    <!-- Adjusted col-lg-3 to accommodate the logo -->
                ...
                <div class="col-lg-6 col-12 d-flex align-items-center justify-content-center">
                    <!-- Adjusted col-lg-6 to accommodate the search input -->
                ...
                <div class="col-lg-1 col-12 text-right d-flex justify-content-end align-items-center">
                    <!-- Adjusted col-lg-3 to accommodate the login/register link -->
                    @if(Auth::check())
                    <a href="{{ route('account.profile') }}" class="nav-link text-dark"> <i> <svg class="nav-icons"
                                xmlns="http://www.w3.org/2000/svg" height="25px" width="25px" viewBox="0 0 448 512">
                    ...
                    <a href="{{ route('account.login') }}" class="nav-link text-dark"> <i>
                            <svg class="nav-icons" xmlns="http://www.w3.org/2000/svg" height="25px" width="25px"
                                fill="black" viewBox="0 0 448 512">
                                <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
                                    d="M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464H398.7c-8.9-63.3-63.3-112-129-112H178.3c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3z" />
                            </svg>
            ...
            <nav class="navbar navbar-expand-xl" id="navbar">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          		...
          		<a class="nav-link active" aria-current="page" href="index.php" title="Products">Home</a>
                        ...
                        <li class="nav-item">
                            <a class="btn btn-dark" aria-current="page" href="{{route('front.home')}}"
                                title="Products">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-dark" aria-current="page" href="#"
                                title="Products">About Us</a>
                ...
                <div class="col-md-4">
                    <div class="footer-card">
                        ...
                        <div class="col-lg-6 logo">
                            <a href="{{ route('front.home') }}" class="text-decoration-none">
                                @if(getLogo()->isNotEmpty())
                                <img src="{{ asset('uploads/logo/'.getLogo()->first()->image) }}" alt="logo"
                                    class="logo">
                                @endif
                            </a>
                        </div>
                        ...
                        <h6>ABABIL EXPORT IMPORT AGENT LIMITED </h6> <br>
                        <p>
                            <i class="fas fa-map-marker-alt"></i> 278 Balfour Road, Ilford, Essex IG1 4HZ. United
                            Kingdom <br>
                            <i class="fas fa-phone"></i> +447908313946
                        </p>
                ...
                <div class="row">
                    <div class="col-12 mt-3 mb-3">
                        <div class="copy-right text-center">
                            <p>&copy; <span id="currentYear"></span> <a target="_blank" href="https://opus-bd.com/">Opus
                                    Technology Limited</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="footer-card">
                        ...
                        <h4>GORUR HUT</h4> <br>
                        <p>The smartest online Gorur hut in Bangladesh </p>

                        <p>
                            <i class="fas fa-map-marker-alt"></i> Dhaka, Bangladesh <br>
                            <i class="fas fa-phone"></i> +0123456789
                        </p>

                        <ul class="social-icons">
                            @if($social = social()->first())
                            @if($social->facebook)
                            ...
                            @endif
                            @if($social->instagram)
                            <li><a href="{{ $social->instagram }}" target="_blank"><i class="fab fa-instagram"></i></a>
                            </li>
                            @endif
                            @if($social->linkedIn)
                            <li><a href="{{ $social->linkedIn }}" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                            </li>
                            @endif
                            @if($social->youtube)
                ...
                <div class="col-md-2">
                    <div class="footer-card">
                        ...
                        {{-- <ul>
                            ...
                            <li><a href="#" title="Boy's">Boy's</a></li>
                            <li><a href="#" title="Girl's">Girl's</a></li>
                            <li><a href="#" title="Kid's">Kid's</a></li>
                        ...
                        <ul class="">
                            ...
                            <li><a class="" href="{{route('front.shop', [$category->slug])}}">{{ $category->name }}</a>
                            </li>
                            @endforeach
                            </li>
                        </ul>
                ...
                <div class="col-md-2">
                    <div class="footer-card">
                        ...
                        <ul>
                            ...
                            <li><i class="fas fa-envelope"></i>gorurhut@gmail.com </li>
                            <li><i class="fas fa-envelope"></i> info@gorurhut.com </li>
                            <li><i class="fas fa-envelope"></i> sales@gorurhut.com</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-2">
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-12 mt-3 mb-3">
                        <div class="copy-right text-center">
                            <p>&copy; <span id="currentYear"></span> <a target="_blank" href="#">GORUR HUT</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
