        ...
        <div class="row ">
                ...
                <div id="product-carouse-two" class="carousel slide">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item {{ ($key == 0) ? 'active' : '' }}">
                            <img class="product-image w-100 h-100" id="productImage"
                                src="{{ asset('uploads/product/item/' . $productItem->image) }}" alt="Product Image">
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="col-md-7">
                <div class="bg-white right">
                    ...
                    <p>Teeth {{ optional($product->brand)->name }}</p>
                    @endif
                ...
                <h2 class="priceItem text-secondary text-secondary-item"
                    id="comparePrice_{{ $product->product_items[0]->id }}"><del>৳{{
                        $product->product_items[0]->compare_price }}</del></h2>
                @endif
                <h2 class="priceItem" id="priceItem_{{ $product->product_items[0]->id }}">৳{{
                    $product->product_items[0]->price }}</h2>
                ...
                <div class="col-md-2">
                    <div id="color-swatches">
                        ...
                        <div class="color-swatch" style="background-color: {{ $color->code }}"
                            data-color-id="{{ $color->id }}" data-product-id="{{ $productItem[" product-item-id"] }}"
                            data-price="{{ $productItem['price'] }}" data-compare-price="{{ $productItem['compare'] }}"
                            data-image="{{ $productItem['image'] }}"></div>
                        @endif
                        @endforeach
                        @endif
                        @endforeach
                ...
                <div class="col-md-2">
                    <div id="size-swatches">
                        ...
                        <div class="size-swatch" style="background-color: {{ $size->code }}"
                            data-size-id="{{ $size->id }}" data-product-id="{{ $productItem[" product-item-id"] }}"
                            data-price="{{ $productItem['price'] }}" data-compare-price="{{ $productItem['compare'] }}"
                    ...
                    <div class="product-image position-relative">
                        <a href="" class="product-img">
                            ...
                            <img class="card-img-top" src="{{ asset('uploads/product/small/' . $productImage->image) }}"
                                class="img-thumbnail" alt="{{ $relProduct->title }}" height="150px" width="150px" />
                            @else
                            <img src="{{ asset('admin-assets/img/default.png') }}" alt="default image" height="150px"
                                width="150px" />
                            @endif
