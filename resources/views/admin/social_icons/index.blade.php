        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    @if (empty($logo))
                            <a href="{{ route('social.create') }}" class="btn btn-primary">New Social icon</a>
                    @endif
                </div>
            </div>
        </div>
                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick ="window.location.href='{{route("social.index")}}'" class="btn btn-default btn-sm">reset</button>
                        </div>
                            ...
                            @if (!empty($social))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" onclick="destroyIcon({{ $social->id}})" class="text-danger w-4 h-4 mr-1">
...
@section('customJs')
   ...
   <script>
    function destroyIcon(id){
        var url = '{{ route("social.delete","ID")}}';
